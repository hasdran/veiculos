    ...
    <div class="container theme-showcase" role="main">
        <div class="page-header">
            <h2 class="form-signin-heading">
                <div id="m_texto"> Detalhes - Ônibus </div>
            </h2>
        </div>          
      ...
      <table class="table table-striped">
        ...
        <tbody>
            <?php 
                $tabelaCabecalho = array("ID VEICULO", "PLACA", "CHASSI", "COR", "ANO", "MARCA", "MODELO", "PESO MÁXIMO","PREÇO","NÚMERO DE RODAS","ID ÔNIBUS","QUANTIDADE DE PASSAGEIROS", "NUMERO DE EIXOS");
                $indice=0;
                include_once ("../Controllers/controllerOnibus.php");
                $carro = controllerOnibus::carregarVeiculo($_GET["id"]);
